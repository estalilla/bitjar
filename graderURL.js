...
References:
  + cheerio
	...
	- http://encosia.com/cheerio-faster-windows0friendly-alternative-jsdom/
...
var clone = function(fn) {
	...
	// http://stackoverflow.com/a/6772748
	return fn.bind({});
};	
...
if(require.main == module) {
	program
		...
		if(program.url) {
		  ...
		  var checkJson = checkHtmlFile('grader.html', program.checks);
